...
class User(models.Model):
    ...
    uphoto = models.CharField(max_length=100, blank=True, null=True)
    uintro = models.TextField()
    ucredit = models.CharField(max_length=16, blank=True, null=True)
    ufriend = models.CharField(max_length=30, blank=True, null=True)
    usubs = models.CharField(max_length=30, blank=True, null=True)
    isactive = models.IntegerField(db_column='isActive')  # Field name made lowercase.
    ugender = models.CharField(max_length=2, blank=True, null=True)
